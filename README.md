...
*The most RECENT version (**LDAC v1.2**) has been released on *Mar 28, 2023*. (An issue with the Recyc. Ratio input error due to cell protection has been fixed on Mar 29, 2023)

...
![License](https://img.shields.io/github/license/lesshsroc/LDAC.svg?style=plastic) ![Star](https://img.shields.io/github/stars/lesshsroc/LDAC.svg?style=plastic) ![commit](https://img.shields.io/github/commits-since/lesshsroc/LDAC/v1.0.svg?style=plastic) ![size](https://img.shields.io/github/repo-size/lesshsroc/LDAC.svg?label=LDAC%20size&style=plastic) ![language](https://img.shields.io/github/languages/top/lesshsroc/LDAC.svg?label=Visual%20Basic%20Application&style=plastic) ![build](/appveyor/ci/:user/:repo.svg)
## 1. Introduction
